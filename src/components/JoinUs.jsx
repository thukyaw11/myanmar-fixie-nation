  ...
  return (
    <div className="rounded-lg w-auto mt-24 grid md:grid-cols-2 grid-cols-1 gap-4 mx-0">
      <div className="flex flex-col justify-center p-10">
        <p className="text-5xl font-semibold">Be a part of our community</p>
        ...
        <div className="flex">
          ...
          <button
            type="button"
            class="text-black font-medium rounded-lg text-sm text-center inline-flex items-center w-36 mt-10 ml-10 transition ease-in-out delay-150 hover:-translate-x-1 duration-500"
          >
            Support Us
            <svg
